(function() {
  ...
  function sessionKey() {
    try {
      return window.sessionStorage && window.sessionStorage.getItem('cerebro-session-key');
    } catch (e) {}
    return null;
  }
  ...
  function showTombstone() {
    ...
    el.innerHTML = '<div style="max-width:480px">' +
      '<h2 style="margin:0 0 .5rem;font-weight:600">Cerebro paused</h2>' +
      '<p style="margin:0;opacity:.85">The Cerebro server has stopped. ' +
      'Ask Claude to bring it back — this page reconnects automatically.</p></div>';
